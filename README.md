...
# Возможности системы
✅ Импорт отчетов 20 брокеров
✅ Импорт сделок по Tinkoff Open API
✅ Ручное добавление сделок с акциями, облигациями, ETF, криптовалютой и фиатом
✅ Ведение сводного портфеля инвестиций
✅ Расчет доходности портфеля (XIRR) с учетом налогов, комиссий и курсовой разницы
✅ График и структура всего портфеля
✅ Иформация о будущих дивидендах
⏳ Импорт сделок по API Binance
